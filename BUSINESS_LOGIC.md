...
Contracts formalize commercial, finance, HR, and other third-party agreements. Invoices turn contract obligations into receivables, while payment recording moves collected money into Finance.
...
| Finance contract  | Client, invoice, payment terms/duration, amount, currency, exchange rate, installment schedule, status                                               | Represents a finance or invoice-related agreement. Selecting an invoice can populate client, title, amount, and currency.                                                                                                                     |
...
| Other contract    | Entity/title, purpose/type, amount, currency, exchange rate, start/end dates, status                                                                 | Records agreements outside the standard customer, finance, or HR domains.                                                                                                                                                                     |
| Invoice           | Contract, client, amount, currency, exchange rate, issue date, due date, status                                                                      | Creates a receivable against a contract. The client must match the selected contract; amount and exchange rate must be positive; due date cannot precede issue date. Base-currency amount is calculated for reporting.                        |
