...
export const financeSalaryAdjustmentSchema = messages =>
  object({
    worked_days: pipe(string(messages.daysInvalid), trim(), regex(INTEGER_PATTERN, messages.daysInvalid)),
    off_days: pipe(string(messages.daysInvalid), trim(), regex(INTEGER_PATTERN, messages.daysInvalid)),
