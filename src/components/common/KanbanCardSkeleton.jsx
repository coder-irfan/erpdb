...
const KanbanCardSkeleton = ({ columns = 4, cards = 3, minWidth = 290 }) => (
  <div className='no-scrollbar flex items-start gap-4 overflow-x-auto py-3' aria-label='Loading board' aria-busy='true'>
    {Array.from({ length: columns }, (_, columnIndex) => (
      <section
        key={columnIndex}
        className='flex flex-col gap-3 rounded-xl bg-actionHover p-3'
