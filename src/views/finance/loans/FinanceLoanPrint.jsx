...
const FinanceLoanPrint = ({ loan, setup, locale }) => {
  ...
  return (
    <PrintLayout
      title={isStaff ? 'STAFF LOAN DISBURSEMENT & RECOVERY VOUCHER' : 'CORPORATE DEBT DISBURSEMENT VOUCHER'}
