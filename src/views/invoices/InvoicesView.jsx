          ...
          <div className='grid is-full grid-cols-2 gap-2 sm:flex sm:is-auto sm:flex-wrap sm:gap-3 sm:justify-end'>
            <TableFiltersPopover activeCount={activeFilterCount} locale={locale}>
                ...
                slotProps={{
                  select: {
                    ...
                    renderValue: selected =>
                      options.statuses.find(status => status.id === selected)?.label || dictionary.filters.allStatuses
                  }
                }}
              >
              ...
              <Autocomplete
                ...
                value={options.contracts.find(contract => contract.id === contractId) || null}
                onChange={(_, value) => {
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                <NativeDateTimeInput
                  locale={locale}
                  label={dictionary.filters.fromDate}
                  value={fromDate}
                  onChange={event => {
                ...
                <NativeDateTimeInput
                  locale={locale}
                  label={dictionary.filters.toDate}
                  value={toDate}
                  onChange={event => {
